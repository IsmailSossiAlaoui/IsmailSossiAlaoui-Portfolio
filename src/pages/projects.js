...
import DESIGNCONF from '../../public/images/projects/DESIGNCONF.png'
...
const Projects = () => {
  return (
    ...
    <Project title='DesignConf'  description="This is a website for a design config I developed Using Webflow"  imageSrc={DESIGNCONF} className={"col-span-6 xl:col-span-12 xl:h-auto "}  linkto={'https://www.figma.com/file/MzTo9bnyR5DyGl3zFrnXdI/Untitled?type=design&node-id=0%3A1&mode=design&t=7LGqDVnUDnhZqRVq-1'}  imageH={"max-h-[390px]"}/>
